# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Microsoft.Graph.WindowsUpdates.private.dll')
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Microsoft.Graph.WindowsUpdates.custom.psm1'
  ...
  if($instance.ProfileName) {
    if(($directories | ForEach-Object { $_.Name }) -contains $instance.ProfileName) {
      ...
      $exportsPath = $null
      Write-Warning "Selected Microsoft Graph profile '$($instance.ProfileName)' does not exist for module 'Microsoft.Graph.WindowsUpdates'. No cmdlets were loaded."
    }
  ...
  if($profileDirectory) {
    Write-Debug "Loaded Microsoft Graph profile '$($profileDirectory.Name)' for module 'Microsoft.Graph.WindowsUpdates'"
  ...
  $instance.Init();
  Write-Debug "Loaded Module 'Microsoft.Graph.WindowsUpdates'"
# endregion

# SIG # Begin signature block
# MIInngYJKoZIhvcNAQcCoIInjzCCJ4sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBf0TFisoagAQwZ
# yo9MmG8vDmW0U9LuzLo+1wH3hjN3HaCCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg8IBGg9gt
# RtYbmaIcNGGniDHik5OTMlk1rMLsD1/tQWswQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQBgC+0xM1aChx8briUxnP/2yYoK7xin6SRGBbuZsRIc
# 1KakiahbH2hR+4DkM5PDK+mms8rzw36JuV9+wjw4jVyVuJpcMzzh/f/vdtFQO0iK
# v4Q304/H75ddkJzNCvak1S5UA4mR1v9khQ9BzA5TZqIwDlvc5BHVTKMjavtSBL5d
# Th4+2UaXcSGLDHeUIwk9U+wsZIp/1RtmvHXTkWBhiWtTpyCIPeLkNRP/yJwWpTLs
# yYHhXF8WrA3NocLEk9Dhg3QhEu6DoBjdu3w7DrBVSsnw0SwN9g1LZXrzExwMGf9H
# XvICALXUqbclGQjwVer8d9fwp0nk6DUtoVbbab4abzoGoYIW/TCCFvkGCisGAQQB
# gjcDAwExghbpMIIW5QYJKoZIhvcNAQcCoIIW1jCCFtICAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIOh0UVNIhyjFLbz5Kwc/WgV+j0JAg/hQR3W3rJvY
# KqGfAgZjI12HWU8YEzIwMjIwOTI4MTkzMDM1LjIxNVowBIACAfSggdCkgc0wgcox
...
# BDAvBgkqhkiG9w0BCQQxIgQgfKApqloxuu1bfZjT+YGVOAdHM7ezkOtTG2kCk61t
# wlQwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBbe9obEJV6OP4EDMVJ8zF8
...
# YoGibYg80wxJDkXFFgv0MA0GCSqGSIb3DQEBCwUABIICAL+td3xQK7Sw1LxxaRzn
# z76g2X2vB1iSTl0gpHLIOVPG5j3c5dRApHq0/uKSbiLkYi2WePt4+SwWQN1aM0Fz
# S0GZRQl0Iv+j1TaqgxkKedS+G/KnNm6bzNqUbGU3pBbftgMuztoKjD+a/2tz8z7F
# 2qqBdiBgCIKz66gKzSl/YxtIO6JuCc22ZnVUZm80mbcon5B8IJflWchdz1SGlBcP
# +6eq66TvqdzyCtltCV1t9sb9TtGtrFrO72SiukjAdmQc3ovKWN9Nmk0vPm1dIRdi
# JGra+vvqkrtuMzyAcfZF2Eqfc62aJFLWdX7+crMS2LweCivlL5nI0JPYCJN8H9zK
# XlLMawxh0EZk2yTPDuhy4N6CNSd62cC2RtYPkczPrtkQwPVWNyKDgWMxqqyJ9HRH
# t8NyhSHIzJJRvXI0gOBpRCG8Aw8hrbMvLZvLeTpOsPsFnOZBzBgwBzEh2PXumw8r
# hailQ6LtiOVOwF8+jCD3TLVrPBFPaKNSEY6VJGDnicHcYXo2QBL5Iy3lqxc4OcLR
# FtBd6LwkVdL46IwASe9D+ACuXS21daco0oUZSw09IKyd8x0cxKAn3EMImSgGsbX3
# f1z+zuWg1F+YCuuZCC7iv8nrtL6DBu4MgYq43/a3gwC+cEyqHKs551IqDHrQ/M1X
# mGq/j2uN2hw0OxaKdUGxPrFB
