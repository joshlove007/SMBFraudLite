...
begin {
    try {
        ...
        $mapping = @{
            Get1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\Get-MgServiceAnnouncementHealthOverviewIssue_Get1';
            GetViaIdentity1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\Get-MgServiceAnnouncementHealthOverviewIssue_GetViaIdentity1';
            List1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\Get-MgServiceAnnouncementHealthOverviewIssue_List1';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Create1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\New-MgServiceAnnouncementHealthOverviewIssue_Create1';
            CreateExpanded1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\New-MgServiceAnnouncementHealthOverviewIssue_CreateExpanded1';
            CreateViaIdentity1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\New-MgServiceAnnouncementHealthOverviewIssue_CreateViaIdentity1';
            CreateViaIdentityExpanded1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\New-MgServiceAnnouncementHealthOverviewIssue_CreateViaIdentityExpanded1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Delete1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\Remove-MgServiceAnnouncementHealthOverviewIssue_Delete1';
            DeleteViaIdentity1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\Remove-MgServiceAnnouncementHealthOverviewIssue_DeleteViaIdentity1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Update1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\Update-MgServiceAnnouncementHealthOverviewIssue_Update1';
            UpdateExpanded1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\Update-MgServiceAnnouncementHealthOverviewIssue_UpdateExpanded1';
            UpdateViaIdentity1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\Update-MgServiceAnnouncementHealthOverviewIssue_UpdateViaIdentity1';
            UpdateViaIdentityExpanded1 = 'Microsoft.Graph.Devices.ServiceAnnouncement.private\Update-MgServiceAnnouncementHealthOverviewIssue_UpdateViaIdentityExpanded1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAN7NdIHqQw+6Y3
# s+0V+isow0J5z5OfGTlZtW9Upb029KCCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgki+jHpdp
# 3ZaDtUawUOG+1mSrHsuxEtdK/f5A29KxProwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAzvoPtm5os2yztbz605OiHV8uinrsaVQOaRLBIDh9Y
# 5lFTOmyacPIqrVWcyZvOuGya9M4TE8Y+ra+y5uY0TpIHVAl/wOLR2teLilOG+CN5
# KECqU3nCjtCe3fa10u4UjmkaDKqxeLPUvaQgzZCxVFJyww9HTDWbIu4E5byCNDFa
# r8VLtzBbRwqGdxVmAisU/Q8e64lwQxVJMg56M23yJMJhVzsv3aKzfs1C549UrrV/
# eQRh2WHS1LymCg2KBwJOA2/5QiOWyXx1+NjTY4xNOsiOkLmzNa+kUjGlCG+tah8B
# XQyPLHUMx0jQyUT5sfvKA37YhkHpY+W7IjYSSsx6+FproYIW/TCCFvkGCisGAQQB
# gjcDAwExghbpMIIW5QYJKoZIhvcNAQcCoIIW1jCCFtICAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIOJMdcmSZMKeByZ2uoZeuWhMHaW1z/6UrHNV7NS8
# aDwHAgZjI12HWTEYEzIwMjIwOTI4MTkzMDM0LjgxOFowBIACAfSggdCkgc0wgcox
...
# BDAvBgkqhkiG9w0BCQQxIgQg8HqCdZyISKGixAsdn1tNblxouj1XMWlZiMcV+oq9
# RDkwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBbe9obEJV6OP4EDMVJ8zF8
...
# YoGibYg80wxJDkXFFgv0MA0GCSqGSIb3DQEBCwUABIICAKbTA8vSY6jrzaMDJ2RB
# i9/UUC57Gj1TKGLvSMxo4FIED5rwwTFEUcPMfyadEkPgsslyVJs7hPEV+Mr28mMx
# 3wRR7xKjHgpcBW6ra2uuyZR+na8KRQ9SFqzpPyXS55csRdFQ/sHBXBRGLKRZ95xj
# W4u1ReYrlyqHEeZKQtGs7+IbtWfSrhcttGTlA3CjoogXZ7CNkwO39Ljer9uINj8l
# aOJbadcJ/zyHgK2yAK8D1CmipIdLR4i7gcRg7+/Tsxm94BjpcY8sxuGLtQtFY4Po
# Q+MiaZxyv7uc2HCPmIj2DwHB0AuxGU8FG2iKRZ56GtB0oV5p7b32SXA0/KvIq+Ak
# zCEPWrLtn/pSRPmrAep3UjQo9LD+7qYTGYYYc4QM4dwBe+EvbTGmA5Bj9UIMn7KL
# rM1yD3e1dEQj8LYteYBVlk6sAm0NAB+y+MrTM2U6tNZPEKymO+FdfpfV09eacKCJ
# WZRgmfCjQM5TSCD5mVmc53BsPIxsMkozqhxXTHWiMVHV8uS/15SFWkdpEMg9O8Ye
# nyCyOxdyQxYwramiGz6lf6U5GPE49pRvQiiKHaMDF/QhLeDapSXK8wf0XsO40itq
# BPJ7BlGge+cW/YLGqQxB7Zk2TxfuzDg745GIviJ/8VlJ/+w025V5mU5B8IBxJjI2
# EQ5637OS7Z9ZoDYB37v0wUFj
