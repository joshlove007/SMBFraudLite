...
Import-Module Az.Aks -RequiredVersion 5.2.0 -Global
...
Import-Module Az.ApplicationInsights -RequiredVersion 2.2.1 -Global
...
Import-Module Az.Compute -RequiredVersion 5.3.0 -Global
...
Import-Module Az.DataFactory -RequiredVersion 1.16.11 -Global
...
Import-Module Az.DataProtection -RequiredVersion 1.0.1 -Global
...
Import-Module Az.EventHub -RequiredVersion 3.2.0 -Global
...
Import-Module Az.Monitor -RequiredVersion 4.4.0 -Global
Import-Module Az.MySql -RequiredVersion 1.1.0 -Global
Import-Module Az.Network -RequiredVersion 5.3.0 -Global
...
Import-Module Az.RecoveryServices -RequiredVersion 6.1.2 -Global
Import-Module Az.RedisCache -RequiredVersion 1.7.0 -Global
...
Import-Module Az.Resources -RequiredVersion 6.5.1 -Global
...
Import-Module Az.Sql -RequiredVersion 4.2.0 -Global
Import-Module Az.SqlVirtualMachine -RequiredVersion 1.1.0 -Global
Import-Module Az.StackHCI -RequiredVersion 1.4.1 -Global
Import-Module Az.Storage -RequiredVersion 5.3.0 -Global
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCoq1O58S8gKaFK
# LJ/G6WFefacGh84zbglyZJbFkFIJrqCCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgWJIDZSz0
# xK40FNYupffNPAuqRw6gaQwXIM64IiqZh8YwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQCUA4Ay7lyQH4vY9kQi2zBwED73PBe+pRWxGiAMr5bh
# ppv/YaXvn18MvEN7eH6t9sQi2PV+s0uMXfLEgpPja6NpChdbcKc3x7GUfYKK6F4z
# YlJGhz/tQ3vdhWiHREovcg7mCoCckULjWIza6iVeJDAdWrFo/KNJArYBrnMEHcFE
# j9xGooRVbKMLwXP5/KjS91LDKvHWO6THilMeh6HT99eBGFGSmkhpRKcMumOXKW/1
# 8xljJdhIlP62g+UbYaukHJVp4uMM5UQou4KDt2tk91MHjnuDFltWn94O2TfC+dVM
# TlujMWw3FaQIrljkAAe5XpMFnx6PXsuuiGrcvjHF0+hkoYIXDDCCFwgGCisGAQQB
# gjcDAwExghb4MIIW9AYJKoZIhvcNAQcCoIIW5TCCFuECAQMxDzANBglghkgBZQME
# AgEFADCCAVUGCyqGSIb3DQEJEAEEoIIBRASCAUAwggE8AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIMcD4L0T1KaCXOI76nY0orKxJ3978aIXsz5SuhoC
# QM02AgZjoaAi0BQYEzIwMjMwMTA2MTAwNDMzLjk0NVowBIACAfSggdSkgdEwgc4x
...
# AzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgERcbd5pd+a/OCOI9It3G
# 0b+RKXu9BBXbbgctk6mYxTEwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCD5
...
# AJo2pBEviA2T980OAmps0Qm36gCebOb0yUJhw3wWZ0mMKlIrrKXuHiiRAmKAShYG
# 7Cdymjp/TGuBVxXQy1keF8Elhg7CHcpQD67iK+rvfhrLoAKqaPF+sZty719G1iXi
# Jp4EdfO0MAZkCdxzVNbgEJQU6R+U7dNb3kdZb4b8dThzd44sgX0YRBL/AG7x/gMo
# PGuX/sNsV5YwEjnorXqC+OGLqJ6B80Mw6iJiV6AsaSoboOh3k2kElLelRVHLc00C
# L2RztmUbEiq0yXMexuQEZsF9ZZu+vFs12tqkKnHQQwfNq8/P7rpCS9woPhDkxHzA
# Ix0OlVLjhFezxH/O+1D85Zyn2jdV3HhdFd2OTQMmk4/FZXOgjxm7owR1Ta8PGzRY
# dLrVqkr2WrLzZ5dDlPX3uvj2EZcR6gjG9PikHhNgZlhpRKgXQLqwJY8KQwJh6w4k
# YoKEh2VpSgksi5EgR9prymZqlI0ks4jm/puJ28k4bCci8ZXs4kSOnzf1Rky9G4Hm
# SC0PulfM5r/wavmppP8ZkTq7fOrvbo2jhYlVG5fYXZXRWkqx8lg5lwfeLeKEvIaZ
# 47JS9G1YzUkl9mv9nHg3zAz4BT1FX2jEGshG9GH3uOJNZe5jZIeBdmr0hdDgBwlw
# veXog0qixXhA5p05HEh0VFJN9rsHaaQzylDq2vrbtwID
