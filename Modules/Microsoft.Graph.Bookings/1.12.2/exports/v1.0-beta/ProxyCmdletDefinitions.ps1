...
begin {
    try {
        ...
        $mapping = @{
            Get1 = 'Microsoft.Graph.Bookings.private\Get-MgBookingBusinessAppointment_Get1';
            GetViaIdentity1 = 'Microsoft.Graph.Bookings.private\Get-MgBookingBusinessAppointment_GetViaIdentity1';
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Create1 = 'Microsoft.Graph.Bookings.private\New-MgBookingBusinessAppointment_Create1';
            CreateExpanded1 = 'Microsoft.Graph.Bookings.private\New-MgBookingBusinessAppointment_CreateExpanded1';
            CreateViaIdentity1 = 'Microsoft.Graph.Bookings.private\New-MgBookingBusinessAppointment_CreateViaIdentity1';
            CreateViaIdentityExpanded1 = 'Microsoft.Graph.Bookings.private\New-MgBookingBusinessAppointment_CreateViaIdentityExpanded1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Delete1 = 'Microsoft.Graph.Bookings.private\Remove-MgBookingBusinessAppointment_Delete1';
            DeleteViaIdentity1 = 'Microsoft.Graph.Bookings.private\Remove-MgBookingBusinessAppointment_DeleteViaIdentity1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Update1 = 'Microsoft.Graph.Bookings.private\Update-MgBookingBusinessAppointment_Update1';
            UpdateExpanded1 = 'Microsoft.Graph.Bookings.private\Update-MgBookingBusinessAppointment_UpdateExpanded1';
            UpdateViaIdentity1 = 'Microsoft.Graph.Bookings.private\Update-MgBookingBusinessAppointment_UpdateViaIdentity1';
            UpdateViaIdentityExpanded1 = 'Microsoft.Graph.Bookings.private\Update-MgBookingBusinessAppointment_UpdateViaIdentityExpanded1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBcDoi+nV4+1BD1
# Zba2tTW0K3mfJ2F/Nsc9Z91TJfzCQqCCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg9NndI1yx
# Pc0vQO78c5mtSArMuJzVs85974s4YelT4EEwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQANAhl3lM1rNt5DlvAYZoiaP02CHgIKGfeVLE8fcqf5
# GN6KHGpPJrSMVvcQhe1mF7PFd947BZh0PfBfrCKPyWOPb8pabi8Sw2GkdVMQXGJ2
# XDsueXd4GtVWSnmVAJw1xltxmYVp+aBKLXVWAOJjZ1f/JVSwEEG34dasHdQi1ko+
# KXmuWJdFiDRFE+NyN7e3xLBVH3lBAV/BiWt/hTa/IAwMae1QNlqRfOj339qKKnHu
# 0DNM+wsKmgTelK4qHCPNT/NiV09eatsvdbJENs8Msd1sjYboaGmlTakwUOupLZq9
# yCPKtXesAxjSYL9d7a2SMWDZsE/CsAeBeYO9eJiYNqIdoYIXADCCFvwGCisGAQQB
# gjcDAwExghbsMIIW6AYJKoZIhvcNAQcCoIIW2TCCFtUCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIJxjk+9kTqNrKdyjMUQm21Un+l92RFNyNeXnEGql
# p+n9AgZjI0sJiygYEzIwMjIwOTI4MTkzMDM0LjY5NFowBIACAfSggdCkgc0wgcox
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQg2WMSKGTC4zQJoiMOPfRHKSs57SDjFJN1kESV
# 3JToNMMwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBc5kvhjZALe2mhIz/Q
...
# eGJBGkTwzmsKo+q0ohYNdofTMA0GCSqGSIb3DQEBCwUABIICAGSa/HFDlJE38gOC
# 67Xs2AankF3lHcr9St2SQD/UM5FePtDYmpCoPEqaxkH/CPAxy/UHfWca/yfdg9wY
# rDybmd22BjSukUzmYpq3/LcfUbRdGaBxDDEJVo7+ewKU6B8DOw2ZXrUBb2zkzp29
# OXcZTuPjynw+QOSmd/aYuDNfF5UgvObqV6rCPuzCd7ejFNTIE/D23/qvf/QKWvuL
# m2je5ra315cpOTyKdrMmCkOFt3KApMLlROKV0r9mYJROL9hGcPjyy2CzZMW2jwRa
# Vw3mUDdsG0qNk37s+x6viimh/xC7kajeVf0XbTMSEmb4nSaN5B/JQdANUGOuRlSa
# TFGjo8q1Ecopt51TSqMf/nEuCentOOgo7jqoyVVHitmzFmobDa9bBoY+laqwKyz4
# nRN06AnpFDJYLlOvbKo/TcrDSFFPhtOs+JxmjO35uOGnMQcipVi0EdvYHQvHwIyS
# lMzvXyRs88GMqRAhZWMQ1qp1aE2kn4ERPAdN4a3omInakppYQ2mysHXrhQw5vbFu
# n2X1oTKWJzh63Lbf9Mlq9CqzL4kxOirGooOsmgUcKoRZahpDIjQlPUvWFfO2hGwr
# aLtvUkXuPrqtAB3EQ1Ep3F1aiBh/H7AG8Cnz/6EiXwCM2++/BJIp3KYEOMpMuE2Z
# byGlfkQVrsGmHn3A8toyAArIbmwz
