...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Update1 = 'Microsoft.Graph.Planner.private\Update-MgGroupPlannerPlanDetail_Update1';
            UpdateExpanded1 = 'Microsoft.Graph.Planner.private\Update-MgGroupPlannerPlanDetail_UpdateExpanded1';
            UpdateViaIdentity1 = 'Microsoft.Graph.Planner.private\Update-MgGroupPlannerPlanDetail_UpdateViaIdentity1';
            UpdateViaIdentityExpanded1 = 'Microsoft.Graph.Planner.private\Update-MgGroupPlannerPlanDetail_UpdateViaIdentityExpanded1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBGAp6RExlP9FgD
# vHcff5Ym/hQ/3NXM3jmEiJnC2WALhaCCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgi5/a1GVN
# 3ISnBS0d3eiSd/I7Uh/BTvVHj0gN4zZHWRkwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQCNRTDSfjaOArkXOXikR4+0xI4SH2vyOcbVynm1NvVj
# cgIs+iPa4zdKg6fIrLV2/z2QygF4kirK8+S3kXngIU2QAc3MmyNiFzHiK520ckfU
# KmflX5utpG0wxHrfGjhKK1dbV6pZgwzETvrhxxiWpxfPTQU9S0PZepxivi+t78Wi
# h4PVOfSCI0rC7eK3c8Y9z1l4mBW9daDIBDq1Fg/GYFMlVTE4uSZMfcyfVdf1kcbv
# CdetdXtOUGSyy9ZdZhZT2epJqfwglkWit8n5hDRJ62VeHrZbUIJahZsgDYjAAYaL
# EkBPl2a5NtcFZw0AuYF2v/xp4hg+V2aFbKO+puykpCKroYIXADCCFvwGCisGAQQB
# gjcDAwExghbsMIIW6AYJKoZIhvcNAQcCoIIW2TCCFtUCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIGspPHLYcHv4+Mr/bpA3b6UwCU/VlanD12NiqGAE
# wRdAAgZjI0sJi08YEzIwMjIwOTI4MTkzMDM1LjI3NlowBIACAfSggdCkgc0wgcox
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgSD1nRNzaH51QbLoHUcRUQwB9nAKQfRZLs4wz
# 9HnWan8wgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBc5kvhjZALe2mhIz/Q
...
# eGJBGkTwzmsKo+q0ohYNdofTMA0GCSqGSIb3DQEBCwUABIICAG75L07aDa59hp16
# 6qNYgZYKmcHkloVNd+YXGCHJRH375vDxLYAADQeyhnjRtneQog9KbH3DOelkKbwO
# 1rE7UjgSYqM/BBqpE9nniD9HbpgdIaKv4Pbrjq7gXbjDgbL9FY+uQqTG1Y0JWwLx
# gjodYd5cnu6eyjLg+eGt+Ea3hZqhM7bcMPuhlSCqWbVJXo1Nm4yJiO4D+vtOLSdB
# CBwv+ezqNt52hBbleos8HZwajtEVBwFFrmYm8vkDm57EzljmRdzmZpYZ56XzeLwD
# DHKaV1bvOLU6+PwaZeUBig6TGfq+ckCsx7Tf0CpJ2yqyMc98uA2Jz60zU//tNorS
# AQT9/HTiUQwRasXCoy50y++tnMs/YGEnh/0NhoE8XCxaKmyfre4PtbATDlQSBJ69
# n0GfLzNix4kI5nc+TtksUphVWETHDiltm6ircMBzCP+A/10JVRWC032AXAT4DuXw
# raN9qhb3Z7FamY42DMUqWtOGKKHXVUlfbFQU8eHgSopt3xyfeosXS8eQGk7DtFGP
# wrqTsaUrr/EW4Yov/xGCrq09I7D1J+Ag4llQ7DOY8x9VCazqWywTmJEDPMBwYHKm
# fIwXX03Yk4NUJLs3lJxTFQx8mePmODZUpL7exFyh0TY6qrn5n6uwSH5yaAFCDIlp
# CTQUoZjzp8ISSIjNmOJXLCIeLkPh
