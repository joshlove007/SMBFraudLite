...
.Link
https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.compliance/get-mgcompliance
#>
function Get-MgCompliance {
[OutputType([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphCompliance])]
...
begin {
    try {
        ...
        $mapping = @{
            Get1 = 'Microsoft.Graph.Compliance.private\Get-MgCompliance_Get1';
        }
...
Please use Get-Help -Online.
.Link
https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.compliance/update-mgcompliance
#>
...
param(
    ...
    [Microsoft.Graph.PowerShell.Runtime.Info(Required, PossibleTypes=([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphCompliance]))]
    [System.Collections.Hashtable]
    # compliance
    ${BodyParameter},
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Update1 = 'Microsoft.Graph.Compliance.private\Update-MgCompliance_Update1';
            UpdateExpanded1 = 'Microsoft.Graph.Compliance.private\Update-MgCompliance_UpdateExpanded1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCnrAxubBiv1BCj
# NPIPdIakrmcDZLFbgwKYKVlO4m7wxKCCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgT1N78kjM
# QGP4wBtZBQRnTuQJ96OgNRd/8O2vykh0pTAwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAbstkycGMZNdf9vPWIIdrvqJATU2un286A1n2hrsko
# mIrldSJICudJlyhuhNbJQvtUIs1faYdUdM9TxOIGMHtiX7ridakVWl02ith8Wwlp
# CYponi/W4ga+z/8ags4t+88+7HVs5KgDp++OsZBuJRqSYbU5/4WiXePHiOLvfTcI
# qWzmNhhfSkDIcshD5IxYEtibDPvd/I2Eh1M5Dxx8hAc567d5nE8ixOdd7KMvDepp
# LHaQcP2SWMYHobZdFWqbdL0lqpu4WbavozPP7AQoAMSKxcZ3k2vDZmsrSikD7a1A
# n58Q2ZHcQJaSF/RqlmkwkIYScu75a+9dfhpELeNpIB7foYIW/TCCFvkGCisGAQQB
# gjcDAwExghbpMIIW5QYJKoZIhvcNAQcCoIIW1jCCFtICAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIJbYe7Yrg6V78ZktY2oXOSZ8iT2fM6/2r/6S7nsm
# JadoAgZjIzZmdxQYEzIwMjIwOTI4MTkzMDM2LjcwN1owBIACAfSggdCkgc0wgcox
...
# BDAvBgkqhkiG9w0BCQQxIgQgBXH6qhSABWKOJu5ysTYrcxPgaUVGt/QvhY10gjrj
# J7AwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCDrCFTxOoGCaCCCjoRyBe1J
...
# 72okagCyG7F7anKEPPMxMA0GCSqGSIb3DQEBCwUABIICAMyZyHtWJ2NpCQMcK7HF
# NqlEE71NY9L5U5p7TJ2lbHho4GXxQBxTWyC5Hx5la2DqmxS7g5+AtQtQ1mksDKDx
# fdgtPQdZ8xGOjdvPZp8V7p3qWovlzoMYTrg3hBSb/TAb4lHXaVulOEi4VCUGcQ8d
# EYgb4T1d6yD8i0ANCe/s5wYygSkp+vkAUJEepFK4UYwDYvbCA1Fu32HsvLYcWVVj
# T2iKlI06XY1V4fMo1Rv3NUDj2cCH8hFBUn8PY3TqGcSbsv1ba+85Ipvp/FGzsuw3
# IRjwTfs6sxP9NaB0ZfDgPf8VZ77inr3HnDFz0hifXPimrIx8+pzkTMAA8rLkd3Ye
# 6RfuX3fberA2IFmikjWz/29Pd3VXYFq054VN0A3KDlzADof9V+mhoDqrxPVDR4wI
# dK0SPg9wk1gLcMrtNCgeP4nOnZP1j0AoAxU8Q4PHlSFMj4GRL3No1K9Mvspe/nCn
# hPdbGvu8JjLHMsKZc9IG29nppradXpB2dCyCRh2PVig3xXL5LTRY6kqDR4Ng/veA
# ylX+4J6eE9EqQrbvnymZJe23vwzzmaS/MzzNGdFB7ruSYvQ5hjJvVwA+ygyr01wh
# SatuAWFs760ViwKllTnO2A+k00u51UqWXhW4TLFe8aMIfMLW77C1XZO92V0Aptur
# UFk1a4pErSROvjkUX6CkYZLE
