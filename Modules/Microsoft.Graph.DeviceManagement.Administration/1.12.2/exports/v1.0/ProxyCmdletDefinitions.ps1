...
[OutputType([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphComplianceManagementPartner1])]
...
[OutputType([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphIosUpdateDeviceStatus1])]
[CmdletBinding(DefaultParameterSetName='List1', PositionalBinding=$false)]
[Microsoft.Graph.PowerShell.Profile('v1.0')]
param(
    [Parameter(ParameterSetName='Get1', Mandatory)]
...
[OutputType([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphMobileThreatDefenseConnector1])]
[CmdletBinding(DefaultParameterSetName='List1', PositionalBinding=$false)]
[Microsoft.Graph.PowerShell.Profile('v1.0')]
param(
    [Parameter(ParameterSetName='Get1', Mandatory)]
...
[OutputType([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphDeviceManagementPartner1])]
[CmdletBinding(DefaultParameterSetName='List1', PositionalBinding=$false)]
[Microsoft.Graph.PowerShell.Profile('v1.0')]
param(
    [Parameter(ParameterSetName='Get1', Mandatory)]
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Get1 = 'Microsoft.Graph.DeviceManagement.Administration.private\Get-MgDeviceManagementPartner_Get1';
            GetViaIdentity1 = 'Microsoft.Graph.DeviceManagement.Administration.private\Get-MgDeviceManagementPartner_GetViaIdentity1';
            List1 = 'Microsoft.Graph.DeviceManagement.Administration.private\Get-MgDeviceManagementPartner_List1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
[OutputType([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphRemoteAssistancePartner1])]
[CmdletBinding(DefaultParameterSetName='List1', PositionalBinding=$false)]
[Microsoft.Graph.PowerShell.Profile('v1.0')]
param(
    [Parameter(ParameterSetName='Get1', Mandatory)]
...
[OutputType([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphResourceOperation1])]
[CmdletBinding(DefaultParameterSetName='List1', PositionalBinding=$false)]
[Microsoft.Graph.PowerShell.Profile('v1.0')]
param(
    [Parameter(ParameterSetName='Get1', Mandatory)]
...
[OutputType([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphDeviceAndAppManagementRoleAssignment1])]
[CmdletBinding(DefaultParameterSetName='List1', PositionalBinding=$false)]
[Microsoft.Graph.PowerShell.Profile('v1.0')]
param(
    [Parameter(ParameterSetName='Get1', Mandatory)]
...
[OutputType([Microsoft.Graph.PowerShell.Models.IMicrosoftGraphTermsAndConditionsAcceptanceStatus1])]
[CmdletBinding(DefaultParameterSetName='List1', PositionalBinding=$false)]
[Microsoft.Graph.PowerShell.Profile('v1.0')]
param(
    [Parameter(ParameterSetName='Get1', Mandatory)]
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Create1 = 'Microsoft.Graph.DeviceManagement.Administration.private\New-MgDeviceManagementPartner_Create1';
            CreateExpanded1 = 'Microsoft.Graph.DeviceManagement.Administration.private\New-MgDeviceManagementPartner_CreateExpanded1';
        }
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand(($mapping[$parameterSet]), [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters}
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($MyInvocation.CommandOrigin)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBYLAsn2lfGByfq
# yOXrbUeC7G1t/Jn57rsOO1tLyacoOaCCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgg0ERn/Hh
# eG24nTzQbbbPPrIKnbojqjtnkfhB+FJKdWIwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAJinVS3xUnhSwVwh7fkBtKCIRAE8L6pP+F1+pxqsVL
# CUAOipBI6BF7+3icz0BRFSo+vphtdMhhrGSwL0Zi2UT11xrIesMlFaolYSzvVRok
# imruka27LFx/NJ/o9OvRH35ISlgl0UHxrjkMyEl8A0t24iI91JuNbpgZ0P4JbQjS
# qsT/rA3PkLc5jBp+21d9+Ti82RHTffhEIXMu0FDr2JiYxLnNlSHskxF0MxXl5xHA
# jWE2QBOz6S+h9MPrey1OeNhVoSAi3+GusLOjyiZqBsy3YmNT+EHdUT29lbJQOcbz
# eOG0hVu4Fw1vQbxaMuOC3Q/U7/kB0cYkJ9najkUQS3tYoYIXADCCFvwGCisGAQQB
# gjcDAwExghbsMIIW6AYJKoZIhvcNAQcCoIIW2TCCFtUCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIIx82muEXl7VSFwTEeF0y0qsUkF7TNDlv212Ty7f
# 8LNIAgZjI0sJi1cYEzIwMjIwOTI4MTkzMDM2LjM2OFowBIACAfSggdCkgc0wgcox
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgveznhGlt4gFL4EYlNX2YoqOg+nWHxjw5MtzV
# w0IgmekwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBc5kvhjZALe2mhIz/Q
...
# eGJBGkTwzmsKo+q0ohYNdofTMA0GCSqGSIb3DQEBCwUABIICAFCwEFgwo3nFtN5M
# 3UhKpkJqd9nWb5ncDbeefliSan5CPC7jMKUVOF/Y/jTQ/JYRBm40lBNnkRkNDqlC
# JYh9CYBNlbtEa/9xUFILVffpNCqLwT3D+2Tgl6Eciy/KOGITItdnCtQIkqkRwmqh
# RPzmXXuDWzqtEufrQ0SnKHUB1xFI7bxLWISK9zoa1bnKwpiLiX5t+/N6xD1MJlhp
# wDsk6CkeaZi+t7eU05gOqFM1ifJcRYiqLwV170ThSZgCloi82gv9EoeiOykUNSXc
# K4/0DRNoCkBqP/wYRBcaZwQt8mp0VmmKE2O4WcPJwpf1kZqyEHitvD4Ld3T52rYN
# jR21CpdE+cRAhVkg+5zkebGhaosKi0KJi04wud1CgKposKHp2LkFhrayEuC7XdhG
# uI7mIAfkIM1gWaRIKp/+q5QMi1KULJ7/r3yCqD7vatNYttTDNnn2cIfAHsgXieTu
# tp8MYQVG7V4LlhfwGowFD0r90qxJFMcr2xZ+reG2pnAVchBtw7I1r7GsH8PR6VNZ
# WxK1YNaXM9X+uuAAgckYUU7k9Ue7IkWfSdFrNRWz2jHSGM5hNt3iB1TS1KHzz3i5
# up8JTGL9wAyE1PD+wfr3IwT3hCJwKBPNWnwA6IAPf4Keq+8sI9bpl4LIXpakQG0S
# YsztaOrZtOPdONo0qJ06sfANonTM
