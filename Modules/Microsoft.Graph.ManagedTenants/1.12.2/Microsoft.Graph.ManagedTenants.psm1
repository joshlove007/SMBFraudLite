# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Microsoft.Graph.ManagedTenants.private.dll')
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Microsoft.Graph.ManagedTenants.custom.psm1'
  ...
  if($instance.ProfileName) {
    if(($directories | ForEach-Object { $_.Name }) -contains $instance.ProfileName) {
      ...
      $exportsPath = $null
      Write-Warning "Selected Microsoft Graph profile '$($instance.ProfileName)' does not exist for module 'Microsoft.Graph.ManagedTenants'. No cmdlets were loaded."
    }
  ...
  if($profileDirectory) {
    Write-Debug "Loaded Microsoft Graph profile '$($profileDirectory.Name)' for module 'Microsoft.Graph.ManagedTenants'"
  ...
  $instance.Init();
  Write-Debug "Loaded Module 'Microsoft.Graph.ManagedTenants'"
# endregion

# SIG # Begin signature block
# MIInngYJKoZIhvcNAQcCoIInjzCCJ4sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDdvGnMVAhzk0jD
# zETUCPgIWg73zx/70aCCT5Y7ts9wPKCCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQguST2CP55
# cyY4/gFtu+eDkPEKwDv4Jk/UCzMXxGNGiJQwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQBmx6IA0w4CWhzqIFEAMZwNlL/TYIiiE0QRJBrQyG79
# THz0NW7NtzVG4t1LV/4YjNzAyLu8RF+3zut7ETXMa7/Rp+/b+nze4s8jVGoEdJQb
# atF9bJuRBeDc8DVem8vtu9Zas0OX3vCztig0srwZzDKJnJw5b+12j4pirTbkQLGB
# ol4Wh68S65U8xSDg9EifDikp+slpF1Q6cJlJWIcLBSv0sWm5vzxlP0soinotl0cK
# lgLbsGxSFBqvy3IFmTcvRtrLWKTFDHWqjyxIKAXvxRO+57NkNwnev8DMUO+ql+Bc
# n6BylIsw/Q6ytyehqwloUil12zci5F95tSYMX5jzieGxoYIW/TCCFvkGCisGAQQB
# gjcDAwExghbpMIIW5QYJKoZIhvcNAQcCoIIW1jCCFtICAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIAHCyFNct/AOf+ttAjssXrUdeX5GOMf6ccWIr+6Y
# s5ipAgZjIzZmd3cYEzIwMjIwOTI4MTkzMDQxLjk2OFowBIACAfSggdCkgc0wgcox
...
# BDAvBgkqhkiG9w0BCQQxIgQgaPcXpzJoajYHSUNx3kpr11tEnl6rRw6JRb2rFef6
# KnEwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCDrCFTxOoGCaCCCjoRyBe1J
...
# 72okagCyG7F7anKEPPMxMA0GCSqGSIb3DQEBCwUABIICADLVkVBj2rpJoxB2+Q/e
# sboolxjoY9PmUP8ejQs/7vEKShd0SgE0Ghi7uEOlWeHI+k2xZ06fi35KjhEcEVVR
# /nTHwd8tLf/On0Ln1lnOgE2WGKM3ID7nzIyNyjD8x7VSBNWM3eOjabNnAKUV77iX
# 3HaZsq6lOiEM4kWH1fBnsf9+xoyfrC4VmYc7YhMayjkZ6QromPOyPeC75Is2sAM0
# Z0Dp/G10XcfnJ2QEqYuodFkFq2xIHkU//ICxunSvov9QZ3DUDFGzr05esCa0oxrq
# lcA5eTgMmq2H3x9UCNOQJfaG8waqYyPT/TfVQpGzsyIRuY85eWZo2pKFvSyfzKpl
# zQDeZEQQOe2VpthZbAnNkFwiQcEsxzu2xq1OQDNnuxVLdVyKzGazqk6Dc6YQI+rj
# OHVnM1kFdpYmdSZ/RekzsQcObXA8os59XGnm/KwPdLEQLktBRl/Kom84n3bfHGaT
# ezDylkBvcfpfSD/jHA+Yp8n72m4qEgtHCyGlhy6+JeFcCejIlV4p4eRgVHq1s6E4
# +bvnqnRwWm7JxkkZx1k9xMc7v+tpf8e3VAWjSPk/G0Nu4mu54XrIbWxgGxRaeDWZ
# 2fMX6+I8ILGgefj5RKEy/xBHCW8VQgqRynCIHWoovuEDGqV4fDcMxrvMx0Jjcags
# 8Zl0k7yAqL0zKnthm2MY8769
