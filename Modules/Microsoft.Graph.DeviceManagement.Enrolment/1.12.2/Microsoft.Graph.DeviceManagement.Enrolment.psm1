# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Microsoft.Graph.DeviceManagement.Enrolment.private.dll')
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Microsoft.Graph.DeviceManagement.Enrolment.custom.psm1'
  ...
  if($instance.ProfileName) {
    if(($directories | ForEach-Object { $_.Name }) -contains $instance.ProfileName) {
      ...
      $exportsPath = $null
      Write-Warning "Selected Microsoft Graph profile '$($instance.ProfileName)' does not exist for module 'Microsoft.Graph.DeviceManagement.Enrolment'. No cmdlets were loaded."
    }
  ...
  if($profileDirectory) {
    Write-Debug "Loaded Microsoft Graph profile '$($profileDirectory.Name)' for module 'Microsoft.Graph.DeviceManagement.Enrolment'"
  ...
  $instance.Init();
  Write-Debug "Loaded Module 'Microsoft.Graph.DeviceManagement.Enrolment'"
# endregion

# SIG # Begin signature block
# MIInngYJKoZIhvcNAQcCoIInjzCCJ4sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBupZ8oRWMLR82c
# 9qIHZUcQ+ajaup1ufc0nRAVdcPHNF6CCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgvP6qCvED
# iZDY3Fe8RGLkuC7On14AozPfCb+C6aDUzTIwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQANwy515MTHSGbHjWC1kXrHslclxooPEIXdmTO9JCpD
# l3Xp2zwvdh6HwbIBuytKgJBiEK9WMo+s+z7tKcWMQeyFTmnXCY9wckqlPkcnOprQ
# X7FCqunYF02O+2M9/G97RtbxuY8HygDxjXBYv0pPfKTZGblAeXsZHCswKRiOw+p0
# wQAAhiCr0TRA4/vdZIriGU7CKdGCjtGkW72fW9Zv529lPzVRfiXLycMtEvGAyNVr
# bElcucR4xZ1jg4275foFaEe/nGpJZQG4TfitFl/wEBU/BKLpVUVYZLDpNMnr2mo/
# VC+Os3idmeoTFRz2L8vMGcWqEsUAgku0LJAzWBUPkkNKoYIW/TCCFvkGCisGAQQB
# gjcDAwExghbpMIIW5QYJKoZIhvcNAQcCoIIW1jCCFtICAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIPOYMFLMyIDPpbwrQFW+zsenTO5IlzaSXCZDDVra
# PfhgAgZjIzZmdvQYEzIwMjIwOTI4MTkzMDM1LjI0OFowBIACAfSggdCkgc0wgcox
...
# BDAvBgkqhkiG9w0BCQQxIgQgZa3wBJ0yTAqRVxBizI7zst+gzXjVbxRhlpJnEE70
# 4UAwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCDrCFTxOoGCaCCCjoRyBe1J
...
# 72okagCyG7F7anKEPPMxMA0GCSqGSIb3DQEBCwUABIICALAcZdMZTpFaJ9NucK2+
# PhfZQHzWdA6idum+cXcFvm0ZqlDfy7nh9Byoy/Zw0rtS0y1EFozycJ6Gyt+gSQEO
# r9+VlTv4BR5VP6m9kHbYpejoVcttzNkYvvRrKvEtSwG6Zw6ODIIIJ8S/55wA0GHQ
# ctleWyLg9upOvDmeA8RJtQtpno/VVW/dUHMUAWf62VSXM+UDWsipp9q3L07t4K1T
# IQb4ZtnOI+GKtH+xfEbrQsrlYZmWRrvAKqnClf08VWT7Z1A+G5/FTUg0EvqN4kKt
# qtxdAb+K2pqrpZRZs02taQQMGVXlbHCIW2IDzDkBNkbZrb/UH3Qs0C3uMiHdu5ta
# r0AcZWS0O0t9JuqYmHN28gDxLtXhM4+RhKlrh8YrYixCZ9A5rLN4VfSLeJ7DQYQP
# ipLexVuaA/cyQqU5Hx6RnPN7lWGbrcrC3H1U9NA5+xRjeTOZCN6dF5cEaR6PGaGH
# r9Xs5O9kuxjwHFGfwvTKsNjEDQbf3D/6GzYgXnIxXh2eya/7v8BmW9XgBSbwK2BA
# 9trYm9GQFxW0t8KBLrU2Dyo5khWaaWOwF1JIlqnF1fS2VaSvoXOqW/1TlwlVU2y6
# BNVL+/wwXfsYP6cN1HlQt6J4LaMRTfWLR39feUvtfFuMsqmcv1HmRis6duZhyGzm
# K7f9GmfNRO6Wi95DRsE0ClGG
